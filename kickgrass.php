            ...
            <div class="tab-head ">
                ...
                <div class=" tab-content tab-content-t ">
                    ...
                    <div class="tab-pane active text-style" id="tab0">
                        <div class=" con-w3l">
                            ...
                            <div class="col-md-3 m-wthree">
                                <form id="burger1" style="display:none;">
                                    <input type="text" name="pid" value="<?php echo $row['PRODUCT_ID'];?>" >
                                    <input type="text" name="pname" value="<?php echo $row['PRODUCT_NAME'];?>" >
                                ...
                                <div class="col-m">
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button onclick="myCart()" class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-toggle="modal" data-target="#myModal" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="images/of.png">Add to Cart</button>
                                        </div>
                                        <script>
                                            /*function myCart() {
                                                //var carts = [];
                                                var carts = $('#burger1').serializeArray();
                                                console.log(carts);
                                                $('.modal-body').append('<h3>'+carts[1].value+'</h><input type="number" name="prc" value="1"><span>Rs.s'+carts[2].value+'</span>');
                                                carts = [];
                                            }*/
                    ...
                    <div class="tab-pane text-style" id="tab1">
                        <div class=" con-w3l">
                            <?php foreach($class['BURGER'] as $row) { $i = 0;?>
                            
                            <form class="burger<?php echo $i; ?>" style="display:none;">
                                    <input type="text" name="pid2" value="<?php echo $row['PRODUCT_ID'];?>" >
                                    <input type="text" name="pname2" value="<?php echo $row['PRODUCT_NAME'];?>" >
                                    <input type="text" name="price3" value="<?php echo $row['PRICE'];?>" >
                           </form>
                            <div class="col-md-3 m-wthree">
                                <div class="col-m">
                                    <a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button onclick="myCart('<?php echo $row['PRODUCT_ID']; ?>','<?php echo $row['PRODUCT_NAME']; ?>' , '<?php echo $row['PRICE']; ?>' );" class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-toggle="modal" data-target="#myModal" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="images/of.png">Add to Cart</button>
                                        </div>
                                        ...
                                        <div id="myModal" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <input id="tot" type="text" name="total">
                                                        <button type="button" class="btn btn-default" data-dismiss="mod  al">Close</button>
                                                    </div>
                                                </div>
...
<script>
    function myCart(id, nm, prc) {
        
        console.log(id);
        console.log(nm);
        console.log(prc);
        
       $('.modal-body').append('<div><h3>'+nm+'</h><input type="number" name="qty"  value="1"><span class="prc">Rs.'+prc+'</span><button class="btn btn-default" onclick=remove(this) >X</buuton></div>');
        //carts.length = 0;
        //console.log(carts);
        //carts.length = 0;
    }
