                    ...
                    <div class="content">
                        <div class="women_main">
			   	   	 ...
			   	   	 <img src="assets/images/biz/kickgrass/<?php echo $row['PRODUCT_ID'];?>.jpg" class="img-responsive" alt="">
                                                            ...
                                                            <div class="grid_1 simpleCart_shelfItem">
                                                                ...
                                                                <div class="item_add" onclick="addingToCart('<?php echo $row['PRODUCT_ID'];?>','<?php echo $row['PRODUCT_NAME'];?>','<?php echo $row['PRICE'];?>')"><span class="item_price"><a href="#">add to cart</a></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php } ?>
			   	   	 ...
			   	   	 <img src="assets/images/biz/kickgrass/<?php echo $row['PRODUCT_ID'];?>.jpg" class="img-responsive" alt="">
                                                            ...
                                                            <div class="grid_1 simpleCart_shelfItem">
                                                                ...
                                                                <div class="item_add"><span class="item_price"><h6>Rs<?php echo $row['PRICE'];?></h6></span></div>
                                                                <div class="item_ad" onclick="addingToCart('<?php echo $row['PRODUCT_ID'];?>','<?php echo $row['PRODUCT_NAME'];?>','<?php echo $row['PRICE'];?>')"><span class="item_price"><a href="#">add to cart</a></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php } ?>
                        ...
                        <div class="footer">
                            <div class="col-md-3 cust">
                                ...
                                <li><a href=".html">How To Buy</a></li>
